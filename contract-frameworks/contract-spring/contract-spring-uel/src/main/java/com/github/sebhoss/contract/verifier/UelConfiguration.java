...
/**
 * Configuration for a UEL based {@link ContractContextFactory}.
 */
@Configuration
public class UelConfiguration {

    /**
     * @return A UEL based {@link ContractContextFactory}.
     */
    @Bean
    public ContractContextFactory contractContextFactory() {
        return new UelBasedContractContextFactory(expressionFactory());
    }
