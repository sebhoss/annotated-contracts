...
public interface ContractVerifier {
    ...
    /**
     * @return {@code true} if the contract has {@link Contract#preconditions() preconditions}, {@code false} otherwise.
     */
    boolean hasPreconditions();

    /**
     * @return {@code true} if the contract has {@link Contract#postconditions() postconditions}, {@code false} otherwise.
     */
