...
import com.github.sebhoss.contract.module.DefaultJBossModule;
...
public class CompanyModule extends AbstractModule {
    ...
    protected void configure() {
        install(new DefaultJBossModule());

        bind(InsuranceCompany.class).to(JbossBasedInsuranceCompany.class).asEagerSingleton();
    }
