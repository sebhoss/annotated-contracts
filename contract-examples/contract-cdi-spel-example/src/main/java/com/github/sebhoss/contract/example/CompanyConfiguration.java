...
/**
 * Configures a SpEL ContractContextFactory.
 */
public class CompanyConfiguration {

    /**
     * @param spelFactory
     *            The SpEL context factory.
     * @return A new context factory.
     */
    @Produces
    @Default
    @SuppressWarnings(CompilerWarnings.STATIC_METHOD)
    public ContractContextFactory contextFactory(final @SpEL ContractContextFactory spelFactory) {
        return spelFactory;
    }
