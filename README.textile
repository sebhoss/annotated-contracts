...
| "UEL":http://en.wikipedia.org/wiki/Unified_Expression_Language | ✓ | | |
...
| "JS":http://download.java.net/jdk8/docs/technotes/guides/scripting/programmer_guide/index.html | ✓ | | |
| "JBoss EL":https://github.com/jboss/jboss-el-api_spec | | | |
