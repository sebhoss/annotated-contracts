 ...
 */
@MVEL
public final class MVELBasedContractContextFactory extends AbstractContractContextFactory {

    @Override
    public ContractContext createContext(final Object instance, final Object[] arguments, final String[] parameterNames) {
        final Map<String, Object> tokens = new HashMap<>(arguments.length + 1);

        setParameters(parameterNames, arguments, tokens::put);
