 ...
 */
@JUEL
public final class JuelBasedContractContextFactory extends AbstractContractContextFactory {
    ...
    public ContractContext createContext(final Object instance, final Object[] arguments, final String[] parameterNames) {
        ...
        setParameters(parameterNames, arguments, (name, value) ->
                elContext.getVariableMapper().setVariable(name, expressionFactory.createValueExpression(value, value.getClass())));
        elContext.getVariableMapper().setVariable(Clause.THIS, expressionFactory.createValueExpression(instance, instance.getClass()));
